...
func (o *Options) ApplyTo(c *schedulerappconfig.Config) error {
	...
	if err := o.LvmConfigMap.ApplyTo(&c.AlgorithmOptionalOptional); err != nil {
		return err
	}
...
func (o *Options) Validate() []error {
	...
	errs = append(errs, o.LvmConfigMap.Validate()...)
